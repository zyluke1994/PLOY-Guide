    ...
    ['Base64', '$http', '$cookieStore', '$rootScope', '$timeout',
        function (Base64, $http, $cookieStore, $rootScope, $timeout) {
            ...
            service.Login = function (username, password, callback) {
                ...
                /*----------------------------------------------*/
                $http.post('https://plan360.ploytrip.com/api/authenticate.php', { 'username': username, 'password': password })
            ...
            service.SignUp = function (signupUsername, signupPassword, signupFullName, signupActivationKey, callback) {

                //Use this for real authentication
                /*----------------------------------------------*/
                $http.post('https://plan360.ploytrip.com/api/authenticate.php', {
                    'updateType': "signup",
            ...
            service.SetCredentials = function (username, password, role) {
                ...
                console.log("from loginCtrl: username= " + username);
    ...
    ['$scope', '$rootScope', '$location', 'AuthenticationService',
        function ($scope, $rootScope, $location, AuthenticationService) {
            ...
            $scope.login = function () {
                ...
                if ($scope.username == "tester123" && $scope.password == "tester123") {
            ...
            $scope.signup = function () {
                ...
                if ($scope.signupPassword === $scope.signupPassword2) {
                    AuthenticationService.SignUp($scope.signupUsername, $scope.signupPassword, $scope.signupFullName, $scope.signupActivationKey, function (response) {
                        console.log(response);
